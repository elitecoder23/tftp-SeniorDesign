...
namespace Tftp
{
	 ...
	 *
	 * The packet handlers are used internally. A user of the TFTP library doesn't
	...
	class TftpPacketHandler
	{
		public:
			 ...
			 *
			 * This handler tries to decode the received packet as TFTP packet and
			 * calls the approbate handler method.
			 *
