 ...
 *
 * @brief Declaration of class TftpServerWriteRequestOperationImpl.
 **/
	...
	namespace Server
	{
		...
		class TftpServerWriteRequestOperationImpl : public TftpServerOperationImpl
		{
			...
			private:
				 ...
				 *
				 * Acknowledgement packets are not expected and handled as invalid. An
				 * error is sent back and the operation is cancelled.
				 **/
