 ...
 *
 * @brief Declaration of class OptionList.
 **/
	...
	namespace Options
	{
		...
		class OptionList
		{
			public:
				 ...
				 *   The name of the option
				 *
				 * @return The value of the option. If the option is not set, an empty
				 *   OptionPointer is returned.
				 **/
				 ...
				 *
				 * When the transfer size option is not set, 0 is returned. Due to the
				 * fact, that 0 is a valid transfer size option value, this value does
				 * not mean that the option is set either.
				 *
