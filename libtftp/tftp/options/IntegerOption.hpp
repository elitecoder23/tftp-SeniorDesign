...
template< typename IntT>
IntT IntegerOption< IntT>::getValue() const
{
  return value;
}

template< typename IntT>
typename IntegerOption< IntT>::string
IntegerOption< IntT>::getValueString() const
{
...
template< typename IntT>
OptionPtr IntegerOption< IntT>::negotiateClient(
  const string &optionValue) const
{
...
template< typename IntT>
typename IntegerOption< IntT>::string IntegerOption< IntT>::toString(
  const IntegerType value)
{
