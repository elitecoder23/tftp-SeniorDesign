 ...
 *
 * @brief Declaration of class TftpPacket.
 **/
	...
	namespace Packet
	{
		...
		class TftpPacket
		{
			...
			protected:
				 ...
				 *
				 * This operation can be dangerous if used for derived classes, e.g.
				 * set the packet type of an TFTP Write Request Packet to TFTP error
				 * packet.
				 *
				 * @param[in] packetType
				 *   The new packet type
