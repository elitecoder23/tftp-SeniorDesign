...
class Packet
{
  public:
     ...
     **/
    static PacketType packetType( RawTftpPacketSpan rawPacket ) noexcept;
  ...
  protected:
     ...
     **/
    Packet( PacketType packetType, RawTftpPacketSpan rawPacket );
     ...
     *   Packet, which shall be decoded.
     **/
    void decodeHeader( RawTftpPacketSpan rawPacket );
