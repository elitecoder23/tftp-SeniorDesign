 ...
 *
 * @brief Declaration of Struct Tftp::Server::WriteOperationConfiguration.
 **/

#ifndef TFTP_SERVER_WRITEOPERATIONCONFIGURATION_HPP
#define TFTP_SERVER_WRITEOPERATIONCONFIGURATION_HPP
